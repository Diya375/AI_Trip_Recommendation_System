...
// import { Copy, Check, Link2, ChevronDown, ChevronUp, Sparkles, Clock } from "lucide-react";
...
//   const [aiItineraryData, setAiItineraryData] = useState(null);
...
//       API.get(`/trips/${id}/ai-itinerary`)
//     ])
//       .then(([tripRes, prefRes, itineraryRes]) => {
//         setTrip(tripRes.data.trip);
//         setMembers(tripRes.data.members);
//         setRole(prefRes.data.role);

//         if (itineraryRes.data && itineraryRes.data.itinerary) {
//           setAiItineraryData(itineraryRes.data.itinerary);
//         }
...
//         setAiItineraryData(response.data.itinerary);
//       }
//     } catch (err) {
...
//               <p style={{ color: "var(--text-dim)", fontSize: "0.85rem", marginBottom: "0.75rem", fontWeight: "700" }}>⏳ Waiting for preferences from:</p>
...
//                     <div style={{ width: "36px", height: "36px", borderRadius: "50%", background: "var(--accent)", display: "flex", alignItems: "center", justifyCenter: "center", fontSize: "0.9rem", color: "#fff", fontWeight: "700", flexShrink: 0 }}>
...
//       {/* ── ✨ SMART AI GENERATIVE ITINERARY ENGINE WORKSPACE ── */}
//       {/* <div style={{ marginTop: "2rem", marginBottom: "2rem" }}>
//         <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5rem" }}>
//           <div>
//             <h3 className="cinzel" style={{ fontSize: "1.3rem", color: "var(--accent)", margin: 0, fontWeight: "700" }}>
//               ✨ Smart AI Itinerary Builder
//             </h3>
//             <p style={{ color: "var(--text-dim)", fontSize: "0.85rem", marginTop: "0.25rem" }}>
//               Combines everyone's preferences into an optimal shared travel master plan layout.
//             </p>
//           </div> */}
...
//               disabled={generatingItinerary || allPreferences.length === 0}
//               className="btn btn-primary"
//               style={{
//                 padding: "0.75rem 1.25rem",
//                 fontSize: "0.88rem",
//                 background: "linear-gradient(135deg, #2B3E34 0%, #14b8a6 100%)",
//                 border: "none",
//                 opacity: (generatingItinerary || allPreferences.length === 0) ? 0.6 : 1,
//                 cursor: "pointer",
//                 fontWeight: "700"
//               }}
//             >
//               {generatingItinerary ? "⏳ Processing..." : "⚡ Generate Shared Plan"}
//             </button>
//           )}
//         </div>
...
//         {/* {generatingItinerary && (
//           <div className="card text-center" style={{ padding: "3rem 2rem", background: "rgba(20, 184, 166, 0.02)" }}>
//             <div style={{ fontSize: "1.5rem", display: "inline-block" }}>🔄</div>
//             <h4 style={{ marginTop: "1rem", color: "var(--text)", fontWeight: "700" }}>Compiling Shared Multi-Day Matrix Loops...</h4>
//           </div>
//         )} */} 

//         {/* ── 📋 CHRONOLOGICAL STEP-BY-STEP ITINERARY DISPATCH LAYER ── */}
//         {aiItineraryData && !generatingItinerary && (
//           <div className="fade-up" style={{ display: "flex", flexDirection: "column", gap: "1.75rem" }}>
//             {aiItineraryData.days?.map((dayPlan, index) => (
//               <div key={index} className="card" style={{ borderLeft: "4px solid var(--accent)", background: "var(--bg-card)" }}>
                
//                 {/* Day Header Title */}
//                 <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "1.25rem", borderBottom: "1px solid var(--border)", paddingBottom: "0.6rem" }}>
//                   <Sparkles size={16} color="var(--accent)" />
//                   <h4 className="cinzel" style={{ margin: 0, color: "var(--accent)", fontSize: "1.1rem", fontWeight: "700" }}>
//                     Day {dayPlan.day}: {dayPlan.theme || "Exploration"}
//                   </h4>
//                 </div>
                
//                 {/* Activity Step Matrix Loops */}
//                 <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
//                   {dayPlan.activities?.map((act, actIdx) => (
//                     <div key={actIdx} style={{ display: "flex", gap: "1.25rem", alignItems: "flex-start" }}>
...
//                       {/* Step Text Fields */}
//                       <div style={{ flex: 1 }}>
//                         <p style={{ fontWeight: "700", margin: 0, fontSize: "0.95rem", color: "var(--text)" }}>
//                           {act.title}
//                         </p>
//                         <p style={{ margin: "0.25rem 0 0 0", fontSize: "0.86rem", color: "var(--text-dim)", lineHeight: "1.45" }}>
//                           {act.description}
//                         </p>
//                       </div>

...
router.get("/:id/expenses", verifyToken, checkTripMembership, async (req, res) => {
  const { id } = req.params;
  try {
...
// Add expense
router.post("/:id/expenses", verifyToken, checkTripMembership, async (req, res) => {
  const { id } = req.params;
...
// Delete expense (owner or admin only)
router.delete("/:id/expenses/:expenseId", verifyToken, checkTripMembership, async (req, res) => {
